package com.yi.project.codeGenerator;

import com.yi.project.core.ProjectConstant;
...
public class CodeGenerator {
     ...
     * 项目基础包路径
     */
    private static final String BASE_PACKAGE_PATH = "\\com\\yi\\project";
    /**
     * 生成的Service存放路径
     */
    private static final String PACKAGE_PATH_SERVICE = BASE_PACKAGE_PATH + "\\service\\";
    /**
     * 生成的Service实现存放路径
     */
    private static final String PACKAGE_PATH_SERVICE_IMPL = BASE_PACKAGE_PATH + "\\service\\impl\\";
    /**
     * 生成的Controller实现存放路径
     */
    private static final String PACKAGE_PATH_CONTROLLER = BASE_PACKAGE_PATH + "\\web\\";

    /**
     * @author 创建者
     */
    private static final String AUTHOR = "YI";
    /**
     * @date 创建时间
     */
    ...
    public static void main(String[] args) {
        // 需要创建的表名称 需要和数据库一一对应
        genCode("game", "gateway_address", "rule_group", "rules", "user_group");
    }
